...
{
    public class MerchantsOldController : BaseController
    {
        ...
        // HTTP POST : Create Action for Merchants
        public async Task<ActionResult> Create(Merchant model)
        {
            try {
                ...
                _db.Merchants.Add(model);
               await _db.SaveChangesAsync();
                return View();
            }
            catch
            {
                return ViewBag.Message = "Something went wrong,Merchant not created, \n Please review your entry and try again. Or contact an administrator";
            }
        }
