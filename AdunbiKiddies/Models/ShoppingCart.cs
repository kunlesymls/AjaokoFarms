    ...
    public partial class ShoppingCart
    {
        ...
        public Sale CreateOrder(Sale sale)
        {
            ...
            foreach (var item in cartItems)
            {
                ...
                sale.SaleDetails.Add(orderDetail);
                storeDB.SaleDetails.Add(orderDetail);

                Product product = storeDB.Products.Find(orderDetail.ProductId);

                int incomingValue = item.Count;
